...
void ICM_20948::enableDebugging(char *debugPort) {
...
ICM_20948_Status_e ICM_20948_I2C::begin(i2c_inst_t *wirePort, bool ad0val, uint8_t ad0pin) {
  // Associate
  _ad0 = ad0pin;
  _i2c = wirePort;
  _ad0val = ad0val;
...
ICM_20948_Status_e ICM_20948_write_I2C(uint8_t reg, uint8_t *data, uint32_t len, void *user) {
  ...
  uint8_t reg_buf[2], buf;
  // reg_buf = reg;

  i2c_inst_t *_i2c = ((ICM_20948_I2C *)user)->_i2c;  // Cast user field to ICM_20948_I2C type and extract the I2C interface pointer
  ...
  i2c_write_blocking(_i2c, addr, data, len, false);
...
ICM_20948_Status_e ICM_20948_read_I2C(uint8_t reg, uint8_t *buff, uint32_t len, void *user) {
  ...
  i2c_write_blocking(_i2c, addr, &reg, 1, true);
  int num_received = i2c_read_blocking(_i2c, addr, buff, len, false);
