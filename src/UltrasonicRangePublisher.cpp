...
UltrasonicRangePublisher::UltrasonicRangePublisher(
    ...
    laser_scan_msg->angle_min = -SONAR_FOV * M_PI / 180;                          // degrees in radians start of scan
    laser_scan_msg->angle_max = SONAR_FOV * M_PI / 180;                           // degrees in radians end of scan
